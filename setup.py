...
test_packages = ["flake8>=3.6.0", "nbval>=0.9.1", "pytest>=4.0.2", "pytest-cov>=2.6.1", "pytest-mock>=1.6.3"]
dev_packages = docs_packages + test_packages + ["matplotlib>=3.0.2", "plotnine>=0.5.1", "jupyter>=1.0.0", "jupyterlab>=0.35.4",]
