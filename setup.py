...
base_packages = ["numpy>=1.16.0", "scipy>=1.2.0", "scikit-learn>=0.20.2",
...
test_packages = ["flake8>=3.6.0", "nbval>=0.9.1", "pytest>=4.0.2", "black>=19.3",
                 "pytest-cov>=2.6.1", "pytest-mock>=1.6.3", "pre-commit>=1.18.3"]
util_packages = ["matplotlib>=3.0.2", "plotnine>=0.5.1", "jupyter>=1.0.0", "jupyterlab>=0.35.4"]
